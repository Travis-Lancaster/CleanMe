...
// import hero from "#src/app/assets/svg/hero.svg?url";
import Banner from "#src/app/assets/svg/banner.svg?react";
import logo from "#src/app/assets/svg/logo.svg?url";
import { useLayoutMenu } from "#src/app/hooks/use-layout-menu";
import { usePreferences } from "#src/app/hooks/use-preferences";
import LayoutFooter from "#src/app/layout/layout-footer";
import { LanguageButton } from "#src/app/layout/layout-header/components/language-button";
import { ThemeButton } from "#src/app/layout/layout-header/components/theme-button";
