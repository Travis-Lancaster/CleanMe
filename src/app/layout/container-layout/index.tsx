import { useDeviceType, useLayoutFooterStyle, useLayoutHeaderStyle } from "#src/app/hooks";
import { usePreferencesStore, useTabsStore } from "#src/app/store";
 ...
 *
 * NO:
 * const ContainerLayout = lazy(() => import("#src/app/layout/container-layout"));
 *
 * YES:
 * import { ContainerLayout } from "#src/app/layout";
 */
