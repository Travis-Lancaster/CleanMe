import { GlobalSpin, Scrollbar } from "#src/app/components";
import { useLayoutContentStyle } from "#src/app/hooks";
import { LayoutFooter } from "#src/app/layout";
import { CSS_VARIABLE_LAYOUT_CONTENT_HEIGHT, ELEMENT_ID_MAIN_CONTENT } from "#src/app/layout/constants";
import { useAccessStore, usePreferencesStore, useTabsStore } from "#src/app/store";
