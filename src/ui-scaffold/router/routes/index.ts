import type { AppRouteRecordRaw, RouteFileModule } from "#src/ui-scaffold/router/types";

import { loginPath } from "#src/ui-scaffold/router/extra-info";
import { ascending } from "#src/ui-scaffold/router/utils/ascending";
import { mergeRouteModules } from "#src/ui-scaffold/router/utils/merge-route-modules";
import { traverseTreeValues } from "#src/ui-scaffold/utils/tree";
