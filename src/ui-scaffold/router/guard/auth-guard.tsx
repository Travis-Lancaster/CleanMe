import { fetchAsyncRoutes } from "#src/ui-scaffold/api/user";
import { useCurrentRoute } from "#src/ui-scaffold/hooks/use-current-route";
import { hideLoading } from "#src/ui-scaffold/plugins/hide-loading";

import { setupLoading } from "#src/ui-scaffold/plugins/loading";
import { exception403Path, exception404Path, exception500Path, loginPath } from "#src/ui-scaffold/router/extra-info";
import { accessRoutes, whiteRouteNames } from "#src/ui-scaffold/router/routes";
import { isSendRoutingRequest } from "#src/ui-scaffold/router/routes/config";
import { generateRoutesFromBackend } from "#src/ui-scaffold/router/utils/generate-routes-from-backend";
import { generateRoutesByFrontend } from "#src/ui-scaffold/router/utils/generate-routes-from-frontend";
