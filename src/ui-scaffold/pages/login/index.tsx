...
// import hero from "#src/ui-scaffold/assets/svg/hero.svg?url";
import Banner from "#src/ui-scaffold/assets/svg/banner.svg?react";
import logo from "#src/ui-scaffold/assets/svg/logo.svg?url";
import { useLayoutMenu } from "#src/ui-scaffold/hooks/use-layout-menu";
import { usePreferences } from "#src/ui-scaffold/hooks/use-preferences";
import LayoutFooter from "#src/ui-scaffold/layout/layout-footer";
import { LanguageButton } from "#src/ui-scaffold/layout/layout-header/components/language-button";
import { ThemeButton } from "#src/ui-scaffold/layout/layout-header/components/theme-button";
